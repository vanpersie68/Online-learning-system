...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\Program Files\\ffmpeg-5.1.2-essentials_build\\ffmpeg-5.1.2-essentials_build\\bin\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "E:\\黑马程序员\\Mybatis-Plus学习资料\\视频-全面学习Mybatis插件之Mybatis-Plus\\第二天视频\\视频\\13.Mybatis-Plus之插件（执行分析插件）";
    String mp4_name = "1.mp4";
    String mp4folder_path = "E:\\test\\";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String ffmpeg_path = "E:\\Program Files\\ffmpeg-5.1.2-essentials_build\\ffmpeg-5.1.2-essentials_build\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "E:\\黑马程序员\\Mybatis-Plus学习资料\\视频-全面学习Mybatis插件之Mybatis-Plus\\第二天视频\\视频\\13.Mybatis-Plus之插件（执行分析插件）.avi";
        //转换后mp4文件的名称
        String mp4_name = "1.mp4";
        //转换后mp4文件的路径
        String mp4_path = "E:\\test\\1.mp4";
        //创建工具类对象
